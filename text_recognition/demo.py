...
from constants import KOR_OCR_MODEL_NAME
...
def call_demo(saved_model: str, image_folder: str):
    ...
    parser.add_argument(
        "--saved_model", default=saved_model, help="path to saved_model to evaluation"
    )
    """ Data processing """
    parser.add_argument(
    ...
    parser.add_argument(
        "--rgb", action="store_true", default=True, help="use rgb input"
    )
    parser.add_argument(
        "--character",
        type=str,
...
if __name__ == "__main__":
    text = call_demo(
        saved_model=KOR_OCR_MODEL_NAME,
        image_folder="resources/results/text_detection/kor/kor_real_1",
    )
    print(text)
